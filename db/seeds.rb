...
Donation.create(artist: artist_2, artist_name: artist_2.name, request: true, youtube_video_id: 'Tc8aid6N5YY', created_at: Time.new(2016, 5, 23).utc, comment: 'Thank you for playing an epic set in front of 10 people.')
Donation.create(artist: artist_3, artist_name: artist_3.name, request: true, youtube_video_id: 'znjLSW8kfBM', created_at: Time.new(2016, 5, 27, 19).utc, comment: "You don't want to miss them on tour with The Black Dahlia Murder. Easily one of the best shows of the year.")
